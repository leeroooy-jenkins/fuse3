...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        var spyFs = new SpyFs(builder.errno(), storage, actions);
        ...
        // начатое - S3Action на этом месте дожидается догрузки частей и завершает загрузки,
        // иначе JVM ушла бы молча, потеряв хвосты (его виртуальные потоки демонские).
